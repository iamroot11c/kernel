...
#define MPIDR_SMP_BITMASK (0x3 << 30) // 0xC000_0000
#define MPIDR_SMP_VALUE (0x2 << 30)   // 0x8000_0000

#define MPIDR_MT_BITMASK (0x1 << 24)  // 0x0100_0000

#define MPIDR_HWID_BITMASK 0xFFFFFF

#define MPIDR_INVALID (~MPIDR_HWID_BITMASK) // 0x00
